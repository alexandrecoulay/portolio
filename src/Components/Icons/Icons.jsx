...
function Icons({ noColor, pointer, hover, className = undefined, onClick = undefined, name, size = 33, margin }) {
    ...
    return (
        ...
        }} onClick={onClick ? onClick : null} className={`${noColor ? "" : styles.primary_color} ${hover ? styles.hover : ""} ${pointer ? styles.pointer : ""} ${className ? className : ""}` } xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 ${svg.w} ${svg.h}`}>
            {
